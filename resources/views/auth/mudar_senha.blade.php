    ...
    <div class="container d-flex justify-content-center align-items-center text-center mb-5">
        <form style="width: 1000px;" action="{{ route("mudar.senha.submit") }}" id="formulario" class="card border-black shadow" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="card-footer d-grid gap-2">                
                <button style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" type="submit" id="salvar" class="btn btn-lg {{ Cache::get('tema') === 'escuro' ? "btn-secondary" : "btn-info" }} fw-bold {{ Cache::get('tema') === 'escuro' ? "text-white" : "text-primary" }} icon-link icon-link-hover focus-ring justify-content-center" name="salvar">
                ...
                <button style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" type="button" id="limpar" class="btn btn-lg {{ Cache::get('tema') === 'escuro' ? "btn-dark" : "btn-secondary" }} fw-bold icon-link icon-link-hover focus-ring focus-ring-secondary justify-content-center" name="limpar" onclick="limparCampos()">
