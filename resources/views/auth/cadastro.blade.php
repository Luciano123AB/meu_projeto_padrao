    ...
    <nav class="navbar {{ session("tema") == "escuro" ? "bg-dark" : "bg-primary" }} bg-gradient border-5 border-bottom border-black shadow mb-1">
        <div class="container-fluid">
            ...
            <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center me-5">
                <a href="{{ route("login") }}" class="btn btn-lg {{ session("tema") == "escuro" ? "btn-secondary" : "btn-info" }} border icon-link icon-link-hover focus-ring focus-ring-light my-1">
                    <svg xmlns="{{ asset("http://www.w3.org/2000/svg") }}" width="16" height="16" fill="currentColor" class="bi bi-arrow-90deg-left me-1" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.146 4.854a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 4H12.5A2.5 2.5 0 0 1 15 6.5v8a.5.5 0 0 1-1 0v-8A1.5 1.5 0 0 0 12.5 5H2.707l3.147 3.146a.5.5 0 1 1-.708.708z"/></svg>
    ...
    <div class="container d-flex justify-content-center align-items-center text-center mb-5">
        <form action="{{ route("cadastroSubmit") }}" id="formulario" class="card border-black shadow w-100 w-md-75 w-lg-50" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="card-header d-flex align-items-center justify-content-center">
                <svg xmlns="{{ asset("http://www.w3.org/2000/svg") }}" width="28" height="28" fill="currentColor" class="bi bi-person-plus me-1" viewBox="0 0 16 16"><path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/><path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5"/></svg>
                
                <label class="fs-5 fs-md-4 fw-bold">CADASTRO</label>
            </div>
            ...
            <div class="card-body row row-cols-1 row-cols-md-2 g-3">
                ...
                <div class="col">
                    ...
                    @if(session("cpfErro"))
                        <div class="alert alert-danger mt-1 mb-0" role="alert">
                            {{ session("cpfErro") }}<svg xmlns="{{ asset("http://www.w3.org/2000/svg") }}" width="16" height="16" fill="currentColor" class="bi bi-info-circle-fill mb-1" viewBox="0 0 16 16"><path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2"/></svg>
                            Tente novamente.
                        </div>
                    @endif
                </div>
