    ...
    <div class="container d-flex justify-content-center align-items-center text-center mb-5">
        <form action="{{ route("cadastroSubmit") }}" id="formulario" class="card border-black shadow w-100 w-md-75 w-lg-50" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="card-footer d-grid gap-2">                
                <button style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" type="submit" id="cadastrar" class="btn btn-lg {{ session('tema') == "escuro" ? "btn-secondary" : "btn-info" }} fw-bold {{ session('tema') == "escuro" ? "text-white" : "text-primary" }} icon-link icon-link-hover focus-ring justify-content-center" name="cadastrar">
                ...
                <button type="button" id="limpar" class="btn btn-lg {{ session('tema') == "escuro" ? "btn-dark" : "btn-secondary" }} fw-bold icon-link icon-link-hover focus-ring focus-ring-secondary justify-content-center" name="limpar" onclick="limparCampos()">
