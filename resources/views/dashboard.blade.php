                ...
                <div class="bg-light border border-black p-3 mx-3 shadow rounded-3">
                    ...
                    <div class="card bg-secondary-subtle mt-3 p-3 shadow-sm rounded-3">
                        <div class="d-flex justify-content-between mb-1">
                            <span class="text-success fw-bold">Permitidos {{ $porcentagemPermitidos }}%</span>
                            
                            <span class="text-danger fw-bold">Negados {{ $porcentagemNegados }}%</span>
                        </div>
    ...
    <script>
        ...
        new Chart(ctx01, {
            ...
            data: {
                labels: ["Usuários"],
                datasets: [
                    { label: "Permitidos", data: [{{ $permitidos }}], backgroundColor: "green", borderColor: "black", borderWidth: 2 },
                    { label: "Negados", data: [{{ $negados }}], backgroundColor: "red", borderColor: "black", borderWidth: 2 }
                ]
            },
        ...
        new Chart(ctx02, {
            ...
            data: {
                ...
                datasets: [{ data: [{{ $permitidos }}, {{ $negados }}], backgroundColor: ["green", "red"], borderColor: "black", borderWidth: 2 }]
            },
