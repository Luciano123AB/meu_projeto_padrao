        ...
        <div class="row flex-wrap">
            ...
            <div class="col-12 col-md-10 py-3">
                <div class="bg-light border border-black p-3 mx-3 shadow rounded-3">
                    <div class="card {{ Cache::get('tema') === 'escuro' ? "bg-secondary-subtle text-black" : "bg-primary-subtle text-primary" }} p-3 mb-3 shadow-sm rounded-3">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            <div class="card {{ Cache::get('tema') === 'escuro' ? "bg-secondary-subtle text-secondary" : "bg-success-subtle text-success" }} p-3 shadow-sm rounded-3">
                                <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="card {{ Cache::get('tema') === 'escuro' ? "bg-secondary-subtle text-dark" : "bg-danger-subtle text-danger" }} p-3 shadow-sm rounded-3">
                                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="card bg-secondary-subtle mt-3 p-3 shadow-sm rounded-3">
                        <div class="d-flex justify-content-between mb-1">
                            <span class="{{ Cache::get('tema') === 'escuro' ? "text-secondary" : "text-success" }} fw-bold">Permitidos {{ $porcentagemPermitidos }}%</span>                            
                            <span class="{{ Cache::get('tema') === 'escuro' ? "text-dark" : "text-danger" }} fw-bold">Negados {{ $porcentagemNegados }}%</span>
                        </div>

                        <div class="progress-stacked border border-black rounded-3">
                            <div style="width: {{ $porcentagemPermitidos }}%;" class="progress" role="progressbar">
                                <div class="progress-bar progress-bar-striped {{ Cache::get('tema') === 'escuro' ? "bg-secondary" : "bg-success" }}"></div>
                            </div>

                            <div style="width: {{ $porcentagemNegados }}%;" class="progress" role="progressbar">
                                <div class="progress-bar progress-bar-striped {{ Cache::get('tema') === 'escuro' ? "bg-dark" : "bg-danger" }}"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        new Chart(ctx01, {
            ...
            data: {
                labels: ["Usuários"],
                datasets: [
                    { label: "Permitidos", data: [{{ $permitidos }}], backgroundColor: "{{ Cache::get('tema') === 'escuro' ? "gray" : "green" }}", borderColor: "black", borderWidth: 2 },
                    { label: "Negados", data: [{{ $negados }}], backgroundColor: "{{ Cache::get('tema') === 'escuro' ? "black" : "red" }}", borderColor: "black", borderWidth: 2 }
                ]
            },
        ...
        new Chart(ctx02, {
            ...
            data: {
                ...
                datasets: [{ data: [{{ $permitidos }}, {{ $negados }}], backgroundColor: ["{{ Cache::get('tema') === 'escuro' ? "gray" : "green" }}", "{{ Cache::get('tema') === 'escuro' ? "black" : "red" }}"], borderColor: "black", borderWidth: 2 }]
            },
