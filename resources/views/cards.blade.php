    ...
    <div class="container-fluid px-2 px-md-3">
        <div class="row flex-wrap">
            ...
            <div class="col-12 col-md-10 py-3">
                <div class="mx-3">
                    <div style="height: 750px;" class="card {{ Cache::get('tema') === 'escuro' ? "bg-dark" : "bg-light" }} d-flex border border-black shadow overflow-y-scroll">
                                    ...
                                    <div class="card h-100 border-2 border-black shadow">
                                        <div class="row g-0">
                                            <div class="col-md-4 bg-light d-flex justify-content-center align-items-center p-2 border-end">
                                                <img src="{{ asset('assets/fotos/' . $foto_padrao) ?? '' }}" alt="Sem foto" class="imagens_cards img-fluid rounded-circle border border-black">
                                            </div>
                                            <div class="col-md-8">
