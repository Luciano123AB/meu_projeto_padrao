                        ...
                        <div class="col">
                            ...
                            <form action="{{ route('pesquisaDataInicialFinal') }}" method="post">
                                ...
                                <div class="input-group flex-column flex-md-row gap-1">
                                    ...
                                    <input style="width: 21%" id="data_inicial" class="form-control" type="text" name="data_inicial" placeholder="DIA/MÊS/ANO">

                                    <input style="width: 21%" id="data_final" class="form-control" type="text" name="data_final" placeholder="DIA/MÊS/ANO">
