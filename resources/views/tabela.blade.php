...
@section("content")
    ...
    <div style="height: 750px;" class="bg-dark border-top border-bottom mx-3 my-5 overflow-auto">
        <table class="table table-hover align-middle shadow">
            <thead class="text-center">
                <tr class="row-cols-7">
                    <th style="width: 1%;" class="col bg-body-secondary border-start border-end border-top border-black">N°</th>
                    <th style="width: 10%;" class="col bg-body-secondary border-end border-top border-black">Foto</th>
                    <th class="col bg-body-secondary border-end border-top border-black">Nome</th>
                    <th class="col bg-body-secondary border-end border-top border-black">Usuario</th>
                    <th class="col bg-body-secondary border-end border-top border-black">Email</th>
                    <th style="width: 6%;" class="col bg-body-secondary border-end border-top border-black">Data Nasc.</th>
                    <th style="width: 4%;" class="col bg-body-secondary border-end border-top border-black">Permissão</th>
                </tr>
            </thead>
                ...
                @if(session("usuario.usuario") == "Administrador")
                    @foreach($usuario->all() as $usuario)
                        <tr class="row-cols-7">
                            ...
                            <td class="col text-center border-end"><a href="{{ "" }}" id="ativo" class="btn btn-success btn-sm focus-ring focus-ring-success" type="button">SIM</a></td>
                            <td class="col text-center border-end"><a href="{{ "" }}" id="ativo" class="btn btn-danger btn-sm focus-ring focus-ring-danger" type="button">NÃO</a></td>
                        </tr>
                    @endforeach
                @else
                    @foreach($usuario->all() as $usuario)
