<nav id="sidebar" class="col-12 col-md-2 bg-white border-top border-end border-bottom border-black mt-3 py-2 overflow-auto" style="border-radius: 0 20px 20px 0; max-height: 280px; transition: transform 0.3s ease; z-index: 1100;">
    <h6 class="fw-bold border-bottom border-black py-1">OPÇÕES:</h6>

    <li class="{{ session("tema") == "escuro" ? "opcao_gray" : "opcao_cyan" }} rounded-end icon-link icon-link-hover p-1">
