    ...
    @if(session("alerta"))
        <script>
            Swal.fire({
                ...
                footer: "<a href='' style='--bs-icon-link-transform: translate3d(0, -.125rem, 0);' id='ok' class='btn btn-{{ session('alerta.cor') }} btn-sm rounded-pill border border-black icon-link icon-link-hover' type='button'><svg xmlns='{{ asset('http://www.w3.org/2000/svg') }}' width='16' height='16' fill='currentColor' class='bi bi-check-circle' viewBox='0 0 16 16'><path d='M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16'/><path d='m10.97 4.97-.02.022-3.473 4.425-2.093-2.094a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05'/></svg>OK</a>",
                showClass: {
                    popup: `
                        animate__animated
                        animate__fadeInUp
    ...
    @if(session("confirmarDelete"))
        <script>
            Swal.fire({
                ...
                showCloseButton: true,
                icon: "warning",
                title: "<label class='py-2'>Atenção!</label>",
    ...
    @if(session("deleteSucesso"))
        <script>
            Swal.fire({
                ...
                showCloseButton: true,
                icon: "success",
                title: "<label class='py-2'>Sucesso!</label>",
    ...
    @if(session("importarErro"))
        <script>
            Swal.fire({
                ...
                showCloseButton: true,
                icon: "error",
                title: "<label class='py-2'>Erro!</label>",
