            ...
            <div style="min-height: 700px;" class="col-12 col-md-10 py-3">
                <div class="row text-center text-md-start align-items-center">
                    ...
                    <div class="col-12 col-md-6 text-center">
                        ...
                        <p class="{{ session('tema') == "escuro" ? "text-white" : "text-black" }}">Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia, fugit totam necessitatibus ab dicta laudantium quibusdam deleniti dolorum accusamus cum voluptatem nobis architecto exercitationem optio id blanditiis placeat. Neque, exercitationem.</p>
                    </div>
                </div>
            </div>
        </div>
