    ...
    <div style="margin-left: 12px; margin-right: 12px;">
        <div class="row vh-100">
            <ul style="height: 500px;" class="col-2 bg-white border-bottom border-end border-black overflow-scroll">
                ...
                <br>
                <li style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" id="opcoes" class="rounded-end icon-link icon-link-hover p-1"><svg xmlns="{{ asset("http://www.w3.org/2000/svg") }}" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/></svg><a href="{{ route("logs", ["id" => Crypt::encrypt(session("usuario.id"))]) }}" id="opcao03" class="link-secondary link-offset-2 link-offset-2-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">Logs</a></li>
                <br>
                <li style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" id="opcoes" class="rounded-end icon-link icon-link-hover p-1"><svg xmlns="{{ asset("http://www.w3.org/2000/svg") }}" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/></svg><a href="{{ route("importarExportar") }}" id="opcao03" class="link-secondary link-offset-2 link-offset-2-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">Importar / Exportar</a></li>
            </ul>
